                ...
                <div class=" w-full p-8 sm:p-10 lg:flex-auto">
                    ...
                    <ul role="list"
                        ...
                        <li class="flex gap-x-3">
                            ...
                            A listing on the site with a link to your website.
                        </li>
                ...
                <div class=" w-full p-8 sm:p-10 lg:flex-auto">
                    ...
                    <ul role="list"
                        ...
                        <li class="flex gap-x-3">
                            ...
                            Listing displayed higher on page
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
                        ...
                        <li class="flex gap-x-3">
                            ...
                            Add a video about your company
                        </li>
                ...
                <div class=" w-full p-8 sm:p-10 lg:flex-auto">
                    ...
                    <ul role="list"
                        ...
                        <li class="flex gap-x-3">
                            ...
                            our company always listed at the top
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
                        ...
                        <li class="flex gap-x-3">
                            ...
                            Video embedded on consulting homepage
                        </li>
                        <li class="flex gap-x-3">
                            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
                            ...
                            Exclusive, limited to 8 companies
                        </li>
