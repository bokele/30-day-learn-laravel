<div>
    ...
    <!-- End Card Blog -->
    @include('livewire.job-profile.partials.experience-modal')
    <x-mary-modal wire:model="deleteExperience" title="Are you sure?">
        <div>You want to delete this loan product</div>

        <x-slot:actions>
            {{-- Notice `onclick` is HTML --}}
            <x-mary-button label="Cancel" @click="$wire.deleteExperience = false" />
