...
@endphp
<x-mary-modal title="Add New Experience" icon="o-plus" separator wire:model="experienceModal" persistent
    class="backdrop-blur ">
    ...
    <div class="relative w-full max-w-full max-h-full" style=" max-width: 80rem;">
        ...
        <x-mary-form wire:submit="save">
            ...
            <x-slot:actions>
                <x-mary-button label="Cancel" @click="$wire.experienceModal = false" />
