                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-2">
                                    <x-input id="project_from" name="project_from" type="text"
                                        autocomplete="project_from" value="{{ $company->project_from }}"
                                        class="block w-full
                                     " />
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-2">
                                    <x-input id="phone_number" name="phone_number" type="text"
                                        autocomplete="phone_number" value="{{ $company->phone_number }}"
                                        class="block w-full
                                     " />
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-2">
                                    <x-input id="website_url" name="website_url" type="text"
                                        autocomplete="website_url" value="{{ $company->website_url }}"
                                        class="block w-full   " />
